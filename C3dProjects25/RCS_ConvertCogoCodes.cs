    ...
    public class ConvertCogoCodesCommand
    {
        ...
        private static readonly Dictionary<string, (string MasterCode, string MasterDesc)> _codeMap =
            ...
            {  
                ...
                { "FCM 4/4", ("CMF 4X4 \\P (NO-ID)", "CMF 4X4 \\P (NO-ID)") },
                { "FH", ("FH Fire Hydrant", "") },
                { "FIP 1/2 CAP/ILL", ("FIP 1/2 \\P (NO-ID)", "FIP 1/2 \\P (NO-ID)") },
                { "FIP 1/2 LB", ("FIP 1/2 \\P (NO-ID)", "FIP 1/2 \\P (NO-ID)") },
                { "FIP 1/2 NO/ID", ("FIP 1/2 \\P (NO-ID)", "FIP 1/2 \\P (NO-ID)") },
                { "FIP 3/4 NO/ID", ("FIP 3/4 \\P (NO-ID)", "FIP 3/4 \\P (NO-ID)") },
                { "FIR 1 NO/ID", ("FIR 1 \\P (NO-ID)", "FIR 1 \\P (NO-ID)") },
                { "FIR 1/2 CAP/ILL", ("FIR 1/2 \\P (NO-ID)", "FIR 1/2 \\P (NO-ID)") },
                { "FIR 1/2 LB", ("FIR 1/2 \\P (NO-ID)", "FIR 1/2 \\P (NO-ID)") },
                { "FIR 1/2 NO/ID", ("FIR 1/2 \\P (NO-ID)", "FIR 1/2 \\P (NO-ID)") },
                { "FIR 5/8 CAP/ILL", ("FIR 5/8 \\P (NO-ID)", "FIR 5/8 \\P (NO-ID)") },
                { "FIR 5/8 NO/ID", ("FIR 5/8 \\P (NO-ID)", "FIR 5/8 \\P (NO-ID)") },
                ...
                { "SIR 1/2*", ("SIR 1/2 \\P ", "SIR 1/2 RCS LB8484") },
