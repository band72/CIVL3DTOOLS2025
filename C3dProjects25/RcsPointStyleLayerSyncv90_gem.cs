...
{
    /// <summary>
    /// v91 (NET Framework 4.8-safe) - PATCHED
    /// Changes: 
    /// - Strict Capitalization for PNT- and TXT- prefixes.
    /// - NormalizeLayerName forces ToUpperInvariant().
    /// - ComputeLabelLayerFromMarker uses "TXT-" prefix.
    /// </summary>
    public class RcsPointStyleLayerSyncv91
    {
        ...
        [CommandMethod("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv91")]
        public static void RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYS91()
        {
            RcsError.RunCommandSafe("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv91", () =>
            {
        ...
        private static string NormalizeLayerName(string layerName)
        {
            ...
            // PATCH: Force ToUpperInvariant to ensure PNT- match and clean casing
            string s = layerName.Trim().ToUpperInvariant();
        ...
        private static string ComputeLabelLayerFromMarker(string markerLayer)
        {
            ...
            // PATCH: Force "TXT-" (uppercase) instead of "txt-"
        ...
        [CommandMethod("RCS_DIAG_DESC_KEYS_V91")]
        public static void RCS_DIAG_DESC_KEYS91()
        {
            RcsError.RunCommandSafe("RCS_DIAG_DESC_KEYS_V91", () =>
            {
                Document doc = Application.DocumentManager.MdiActiveDocument;
                if (doc == null) throw new InvalidOperationException("No active document.");
