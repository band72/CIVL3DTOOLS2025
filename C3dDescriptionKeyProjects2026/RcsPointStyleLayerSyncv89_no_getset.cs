...
namespace RCS.C3D2025
{
    ...
    /// </summary>
    public class RcsPointStyleLayerSyncv89
    {
        ...
        [CommandMethod("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv89")]
        public static void RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYS()
        {
            RcsError.RunCommandSafe("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv89", () =>
            {
