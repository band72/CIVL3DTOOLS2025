...
namespace RCS.C3D2025
{
    ...
    /// </summary>
    /// 
    public class RcsPointStyleLayerSyncv71
    {
        // --- Output files ---
        ...
        [CommandMethod("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv71")]
        public static void RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYS()
        {
            RcsError.RunCommandSafe("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv71", () =>
            {
        ...
        [CommandMethod("RCS_DIAG_DESC_KEYSv2")]
        public static void RCS_DIAG_DESC_KEYS()
        {
            RcsError.RunCommandSafe("RCS_DIAG_DESC_KEYSv2", () =>
            {
                Document doc = Application.DocumentManager.MdiActiveDocument;
                if (doc == null) throw new InvalidOperationException("No active document.");
