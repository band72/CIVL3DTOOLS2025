...
namespace RCS.C3D2025
{
    ...
    public class RcsPointStyleLayerSyncv90
    {
        ...
        [CommandMethod("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv93")]
        public static void RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYS93()
        {
            RcsError.RunCommandSafe("RCS_SYNC_POINTSTYLE_LAYERS_FROM_DESC_KEYSv93", () =>
            {
            ...
            Editor ed)
        {
            ...
            // Fallback: some Civil 3D builds expose different component names in Profile/Section.
            // As a best-effort, attempt to set layer on ANY child display-style objects within the view collection.
            // This prevents "Model/Profile/Section not filled" when component name is not exactly "Marker"/"Label".
            // IMPORTANT: Profile/Section do NOT expose "Label" in your template (marker only).
            // Do NOT force-set all components to a label layer, or you'll accidentally put the Profile/Section marker on the label layer.
        ...
        [CommandMethod("RCS_DIAG_DESC_KEYS_V93")]
        public static void RCS_DIAG_DESC_KEYS93()
        {
            RcsError.RunCommandSafe("RCS_DIAG_DESC_KEYS_V93", () =>
            {
                Document doc = Application.DocumentManager.MdiActiveDocument;
                if (doc == null) throw new InvalidOperationException("No active document.");
